...
- Generated: `2026-02-23T17:28:27.645933`
- Datasets: `Dataset-1-stageB, NVIDIA-dataset-stageB`
- Selected detectors: `24`
- Ranked complete detectors: `6`
- Output dir: `/Users/Hao/thesis-project/training/results/stage_b_spatial`

## Top 3 Champions

| Rank | Detector | Family | Score | AUC(mean) | AP(mean) | EER(mean) | ACC(mean) | AUC gap | Runtime(s) |
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | MesoNet (`mesonet`) | naive | 0.410195 | 0.608183 | 0.553272 | 0.420700 | 0.501050 | 0.183003 | 168.326 |
| 2 | Xception (`xception`) | naive | 0.350564 | 0.544289 | 0.585693 | 0.478300 | 0.551450 | 0.241861 | 289.944 |
| 3 | MesoInception (`mesoinception`) | naive | 0.350547 | 0.514404 | 0.506890 | 0.483200 | 0.516300 | 0.101023 | 173.000 |

## Failed or Missing Runs

| Detector | Dataset | Status | Detail | Log |
|---|---|---|---|---|
| `efficientnet-b4` | `Dataset-1-stageB` | `failed` | `nonzero_exit_or_metrics_missing` | `/Users/Hao/thesis-project/training/results/stage_b_spatial/logs/efficientnet-b4__Dataset-1-stageB.log` |
| `efficientnet-b4` | `NVIDIA-dataset-stageB` | `failed` | `nonzero_exit_or_metrics_missing` | `/Users/Hao/thesis-project/training/results/stage_b_spatial/logs/efficientnet-b4__NVIDIA-dataset-stageB.log` |
...
| `ffd` | `Dataset-1-stageB` | `failed` | `nonzero_exit_or_metrics_missing` | `/Users/Hao/thesis-project/training/results/stage_b_spatial/logs/ffd__Dataset-1-stageB.log` |
| `ffd` | `NVIDIA-dataset-stageB` | `failed` | `nonzero_exit_or_metrics_missing` | `/Users/Hao/thesis-project/training/results/stage_b_spatial/logs/ffd__NVIDIA-dataset-stageB.log` |
| `core` | `Dataset-1-stageB` | `failed` | `nonzero_exit_or_metrics_missing` | `/Users/Hao/thesis-project/training/results/stage_b_spatial/logs/core__Dataset-1-stageB.log` |
| `core` | `NVIDIA-dataset-stageB` | `failed` | `nonzero_exit_or_metrics_missing` | `/Users/Hao/thesis-project/training/results/stage_b_spatial/logs/core__NVIDIA-dataset-stageB.log` |
| `ucf` | `Dataset-1-stageB` | `failed` | `nonzero_exit_or_metrics_missing` | `/Users/Hao/thesis-project/training/results/stage_b_spatial/logs/ucf__Dataset-1-stageB.log` |
| `ucf` | `NVIDIA-dataset-stageB` | `failed` | `nonzero_exit_or_metrics_missing` | `/Users/Hao/thesis-project/training/results/stage_b_spatial/logs/ucf__NVIDIA-dataset-stageB.log` |
...
- Raw run table: `/Users/Hao/thesis-project/training/results/stage_b_spatial/raw_runs.csv`
- Detector summary: `/Users/Hao/thesis-project/training/results/stage_b_spatial/detector_summary.csv`
- Champion JSON: `/Users/Hao/thesis-project/training/results/stage_b_spatial/champions.json`
- Run config: `/Users/Hao/thesis-project/training/results/stage_b_spatial/run_config.json`
